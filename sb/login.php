...
if (isset($_POST['submit'])) {
    $user = $_POST["email"];
    $password = $_POST['pass'];
    $sql = "SELECT * FROM `user` WHERE email='$user' AND pass='$password'";
...
<head>
    ...
    <style>
        .bg-login-image {
            background: url(https://www.simplilearn.com/ice9/free_resources_article_thumb/The_Top_35_IoT_Terms.jpg);
        }
    </style>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="login.php">
                                        ...
                                        <div class="text-center">
                                        <a class="small" href="../../cms/login.php">Admin Login</a>
                                         </div>
                                        <hr>
