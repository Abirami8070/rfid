    ...
    <div class="sidebar pb-4 mb-4">
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item dropdown">
            <a href="./index.php?page=gps" class="nav-link nav-track">
          ...
          <li class="nav-item dropdown">
            <a href="./index.php?page=rfid" class="nav-link nav-track">
              <i class="nav-icon fas fa-location"></i>
              <p>
                RFID
              </p>
          ...
          <li class="nav-item dropdown">
            <a href="./index.php?page=load" class="nav-link nav-track">
              <i class="nav-icon fas fa-location"></i>
              <p>
                Load Cell
              </p>
          ...
          <li class="nav-item dropdown">
            <a href="./index.php?page=history" class="nav-link nav-track">
              <i class="nav-icon fas fa-location"></i>
              <p>
                History
              </p>
          ...
          <li class="nav-item dropdown">
            <a href="./index.php?page=delivery" class="nav-link nav-feedback">
              <i class="nav-icon fas fa-file"></i>
              <p>
                Delivery status
              </p>
